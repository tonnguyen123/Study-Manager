...
public class toDoTest {
    ...
    public void toDoTest() {
        ...
        ViewInteraction button2 = Espresso.onView(
                Matchers.allOf(ViewMatchers.withText("Advanced Design and Analysis of Algorithms\nShahin Kamali\nA01"),
                        childAtPosition(
        ...
        ViewInteraction materialButton6 = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.button8), ViewMatchers.withText("To_do_list"),
                        childAtPosition(
                                childAtPosition(
                                        ViewMatchers.withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction floatingActionButton = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.bt_add),
                        childAtPosition(
                                Matchers.allOf(ViewMatchers.withId(R.id.activity_find),
                                        childAtPosition(
                                                ViewMatchers.withId(android.R.id.content),
                                                0)),
                                2),
        ...
        ViewInteraction appCompatEditText6 = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.popup_comment_edt),
                        childAtPosition(
                                ViewMatchers.withId(R.id.popup_comment_parent),
                                0),
                        ViewMatchers.isDisplayed()));
        appCompatEditText6.perform(ViewActions.replaceText("asd"), ViewActions.closeSoftKeyboard());

        ViewInteraction materialTextView = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.popup_comment_send_tv), ViewMatchers.withText("submit"),
                        childAtPosition(
                                ViewMatchers.withId(R.id.popup_comment_parent),
                                2),
                        ViewMatchers.isDisplayed()));
        ...
        ViewInteraction materialCheckBox = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.cb),
                        childAtPosition(
                                childAtPosition(
                                        ViewMatchers.withId(R.id.item_city_cv),
                                        0),
                                0),
                        ViewMatchers.isDisplayed()));
        ...
        ViewInteraction appCompatImageView = Espresso.onView(
                Matchers.allOf(ViewMatchers.withId(R.id.iv_delete),
                        childAtPosition(
                                childAtPosition(
                                        ViewMatchers.withId(R.id.item_city_cv),
                                        0),
